...
In [line 31](./index.js#L31), the application is getting query param called *name*. In [line 33](./index.js#L33) is creating a condition of existence of *name* query param. If *name* exist, we use a custom message, saying *"Welcome, name"*.